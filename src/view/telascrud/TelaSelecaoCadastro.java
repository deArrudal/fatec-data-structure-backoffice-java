...
public class TelaSelecaoCadastro extends JFrame {
	...
	private ActionListener confirmar(LinkedList<ClientePF> listaClientePF, LinkedList<ClientePJ> listaCLientePJ,
			LinkedList<Produto>[] tabelaProduto, LinkedList<Categoria> listaCategoria) {
		ActionListener confirmar = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				switch ((String) cbCategoria.getSelectedItem()) {
					case "ClienteCPF":
						TelaInserirClienteCPF cpf = new TelaInserirClienteCPF(listaClientePF, listaCLientePJ,
								tabelaProduto, listaCategoria);
						cpf.setVisible(true);
						break;
					case "ClienteCNPJ":
						TelaInserirClienteCNPJ cnpj = new TelaInserirClienteCNPJ(listaClientePF, listaCLientePJ,
								tabelaProduto, listaCategoria);
						cnpj.setVisible(true);
						break;
					case "Produto":
						TelaInserirProduto prod = new TelaInserirProduto(listaClientePF, listaCLientePJ, tabelaProduto,
								listaCategoria);
						prod.setVisible(true);
						break;
					case "Categoria":
						TelaInserirCategoria cat = new TelaInserirCategoria(listaClientePF, listaCLientePJ,
								tabelaProduto, listaCategoria);
						cat.setVisible(true);
						break;
				}
